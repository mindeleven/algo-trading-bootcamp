...
def read_fem_resp(dct_file="../assets/data/2002FemResp.dct", dat_file="../assets/data/2002FemResp.dat.gz"):
...
def read_fem_preg(dct_file="../assets/data/2002FemPreg.dct", dat_file="../assets/data/2002FemPreg.dat.gz"):
...
def read_fem_resp2010():
    ...
    df = read_fem_resp(
        "../assets/data/2006_2010_FemRespSetup.dct", "../assets/data/2006_2010_FemResp.dat.gz", usecols=usecols
    )
    df["evrmarry"] = df.evrmarry == 1
...
def read_fem_resp2013():
    ...
    df = read_fem_resp(
        "2011_2013_FemRespSetup.dct", "../assets/data/2011_2013_FemRespData.dat.gz", usecols=usecols
    )
    df["evrmarry"] = df.evrmarry == 1
...
def read_variables():
    ...
    """
    vars1 = parse_stata_dict("../assets/data/2002FemPreg.dct").names
    vars2 = parse_stata_dict("../assets/data/2002FemResp.dct").names
